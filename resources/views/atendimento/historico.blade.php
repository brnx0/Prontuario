            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-2" id="btnImprimir" >
                        <button class="btn btn-success" onclick="imprimirAtendimento('atend_cod')"  title="Imprimir Ficha de Atendimento">
                            <i class="fa-solid fa-print"></i>
                        </button>
                        <button class="btn btn-primary" onclick="imprimirReceita('atend_cod')" title="Imprimir Receita">
