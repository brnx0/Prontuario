                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 mb-6">
                    <form @submit.prevent="submitFilter" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                        ...
                        <div>
                            ...
                            <input v-model="filterForm.crm" type="text"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:bg-gray-700 dark:text-white"
                        ...
                        <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                <div class="sm:col-span-4">
                                    ...
                                    <input v-model="form.nomeMedico" type="text" required
                                        class="mt-1 block w-full border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white rounded-md shadow-sm">
                                    <p v-if="form.errors.nomeMedico" class="mt-1 text-sm text-red-500">{{
                                        form.errors.nomeMedico
                                    }}</p>
                                </div>

                                <div class="sm:col-span-2">
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300">CRM</label>
                                    <input v-model="form.crmMedico" type="text" required
                                        class="mt-1 block w-full border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white rounded-md shadow-sm">
                                    <p v-if="form.errors.crmMedico" class="mt-1 text-sm text-red-500">{{
                                        form.errors.crmMedico
                                    }}</p>
                                </div>
                            </div>
                        </div>
