    ...
    <AppLayout>
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                >
                    <svg
                        class="h-6 w-6 text-blue-500 dark:text-blue-400 flex-shrink-0"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                    >
                    ...
                    <div>
                        ...
                        <p class="text-xs text-blue-600 dark:text-blue-400">
                            Esta tela é apenas para visualização de registros.
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                            <input
                                v-model="filterForm.dataAtendimento"
                                type="date"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:bg-gray-700 dark:text-white"
                            />
                        </div>
                        ...
                        >
                            ...
                            >
                                <tr v-for="at in dataLists" :key="at.atend_cod">
                                    ...
                                    <td
                                        class="px-6 py-4 text-gray-900 dark:text-gray-100 truncate max-w-sm"
                                    >
                                        {{ at.situacao_queixa }}
                                    </td>
                                </tr>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-12 gap-4">
                                <div class="col-span-12 sm:col-span-7">
                                    ...
                                    <input
                                        ...
                                        disabled
                                        :value="
                                            activeAtendimento.paciente?.nome
                                        "
                                ...
                                <div class="col-span-12 sm:col-span-3">
                                    ...
                                    <input
                                        ...
                                        disabled
                                        :value="
                                            activeAtendimento.dt_atendimento
                                        "
                                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300"
                                    />
                                </div>
                                <div
                                    class="col-span-12 sm:col-span-2 flex flex-col justify-end space-y-2"
                                >
                                    <button
                                        @click="
                                            imprimirFicha(
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-12 gap-4">
                                <div class="col-span-12 sm:col-span-8">
                                    ...
                                    <input
                                        ...
                                        disabled
                                        :value="
                                            activeAtendimento.medico?.med_nome
                                        "
                                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300"
                                    />
                                </div>
                                <div class="col-span-12 sm:col-span-4">
                                    ...
                                    <input
                                        ...
                                        disabled
                                        :value="
                                            activeAtendimento.especialidade
                                                ?.escp_desc
                                        "
                                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300"
                                    />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    disabled
                                    :value="
                                        activeAtendimento.enfermeiro?.enf_nome
                                    "
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300"
                                />
                            </div>
                            ...
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300"
                                    >Situação/Queixa</label
                                >
                                <input
                                    type="text"
                                    disabled
                                    :value="activeAtendimento.situacao_queixa"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    rows="3"
                                    disabled
                                    :value="activeAtendimento.desc_caso"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300"
                                ></textarea>
                            </div>
                            <div>
                                ...
                                <textarea
                                    rows="3"
                                    disabled
                                    :value="activeAtendimento.receituario"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300"
                                ></textarea>
                            </div>
                        </div>
